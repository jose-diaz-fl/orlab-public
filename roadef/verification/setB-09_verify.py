"""Public verification test for ROADEF 2026 T-ASR instance setB-09.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-09-srpaths.json

Run this self-contained state check:  python setB-09_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-09-srpaths.json")
