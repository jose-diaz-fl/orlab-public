"""Public verification test for ROADEF 2026 T-ASR instance setB-11.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-11-srpaths.json

Run this self-contained state check:  python setB-11_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-11-srpaths.json")
