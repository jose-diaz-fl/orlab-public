"""Public verification test for ROADEF 2026 T-ASR instance setA-08.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-08-srpaths.json

Run this self-contained state check:  python setA-08_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-08-srpaths.json")
