"""Public verification test for ROADEF 2026 T-ASR instance setA-10.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-10-srpaths.json

Run this self-contained state check:  python setA-10_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-10-srpaths.json")
