"""Public verification test for ROADEF 2026 T-ASR instance setA-01.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-01-srpaths.json

Run this self-contained state check:  python setA-01_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-01-srpaths.json")
