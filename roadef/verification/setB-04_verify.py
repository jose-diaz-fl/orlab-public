"""Public verification test for ROADEF 2026 T-ASR instance setB-04.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-04-srpaths.json

Run this self-contained state check:  python setB-04_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-04-srpaths.json")
