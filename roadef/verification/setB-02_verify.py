"""Public verification test for ROADEF 2026 T-ASR instance setB-02.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-02-srpaths.json

Run this self-contained state check:  python setB-02_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-02-srpaths.json")
