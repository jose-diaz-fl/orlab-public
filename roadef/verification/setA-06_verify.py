"""Public verification test for ROADEF 2026 T-ASR instance setA-06.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-06-srpaths.json

Run this self-contained state check:  python setA-06_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-06-srpaths.json")
