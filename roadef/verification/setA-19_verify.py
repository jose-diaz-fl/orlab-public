"""Public verification test for ROADEF 2026 T-ASR instance setA-19.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-19-srpaths.json

Run this self-contained state check:  python setA-19_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-19-srpaths.json")
