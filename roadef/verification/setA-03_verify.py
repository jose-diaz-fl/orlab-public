"""Public verification test for ROADEF 2026 T-ASR instance setA-03.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-03-srpaths.json

Run this self-contained state check:  python setA-03_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-03-srpaths.json")
