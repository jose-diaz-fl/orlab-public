"""Public verification test for ROADEF 2026 T-ASR instance setB-08.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-08-srpaths.json

Run this self-contained state check:  python setB-08_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-08-srpaths.json")
