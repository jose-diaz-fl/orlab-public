"""Public verification test for ROADEF 2026 T-ASR instance setB-03.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-03-srpaths.json

Run this self-contained state check:  python setB-03_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-03-srpaths.json")
