"""Public verification test for ROADEF 2026 T-ASR instance setA-15.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setA-15-srpaths.json

Run this self-contained state check:  python setA-15_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setA-15-srpaths.json")
