"""Public verification test for ROADEF 2026 T-ASR instance setB-01.
...
challenge site (see roadef/README.md) and run:
    ...
    run.sh <net.json> <tm.json> <scenario.json> roadef/solutions/setB-01-srpaths.json

Run this self-contained state check:  python setB-01_verify.py
"""
import json
import os
...
SOLUTION = os.path.join(ROOT, "solutions", "setB-01-srpaths.json")
